...
const diseaseDatabase = {
    ...
    "Apple___Black_rot": {
      ...
      causes: [
        ...
        "Enters through wounds in fruit"
      ],
      treatments: {
        organic: [
    ...
    "Apple___Cedar_apple_rust": {
      ...
      treatments: {
        ...
        chemical: [
          "Myclobutanil or triadimefon fungicides"
        ]
      }
    },
    "Apple___healthy": {
    ...
    "Cherry_(including_sour)___Powdery_mildew": {
      ...
      treatments: {
        ...
        chemical: [
          "Sulfur or triforine fungicides"
        ]
      }
    },
    ...
    "Corn_(maize)___Cercospora_leaf_spot Gray_leaf_spot": {
      ...
      treatments: {
        ...
        chemical: [
          "Apply azoxystrobin or pyraclostrobin fungicides"
        ]
      }
    },
    ...
    "Grape___Black_rot": {
      ...
      treatments: {
        ...
        chemical: [
          "Mancozeb or captan fungicides"
        ]
      }
    },
    "Grape___Esca_(Black_Measles)": {
      name: "Esca (Black Measles)",
      description: "Chronic wood disease causing leaf discoloration and berry spots.",
      treatments: {
        management: [
    ...
    "Squash___Powdery_mildew": {
      ...
      treatments: {
        ...
        chemical: [
          "Sulfur or potassium bicarbonate fungicides"
        ]
      }
    },
    ...
    "Strawberry___Leaf_scorch": {
      ...
      treatments: {
        ...
        chemical: [
          "Captan or thiophanate-methyl fungicides"
        ]
      }
    },
    ...
    "Tomato___Septoria_leaf_spot": {
      ...
      treatments: {
        ...
        chemical: [
          "Mancozeb or copper fungicides"
        ]
      }
    },
    "Tomato___Spider_mites Two-spotted_spider_mite": {
      name: "Spider Mites",
      description: "Tiny yellow stippling on leaves with fine webbing underneath.",
      treatments: {
        organic: [
